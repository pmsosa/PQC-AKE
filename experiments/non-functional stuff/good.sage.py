...
# This file was *autogenerated* from the file good.sage
...
e = [ _sage_const_2 ,-_sage_const_1 ,_sage_const_2 , _sage_const_1 ] ##__genPolynomial(n,q,check_inverse=False)
print "r:",r
print "e:",e
